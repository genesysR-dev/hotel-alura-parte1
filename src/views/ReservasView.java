...
public class ReservasView extends JFrame {
	...
	private ReservasController reserva;
	...
	public ReservasView() throws SQLException {
		...
		this.reserva = new ReservasController();
		...
		lblSeguinte.setBounds(10, 0, 122, 35);
	...
	public void salvar()  {
		try {
			String DataE = ((JTextField)ReservasView.txtDataE.getDateEditor().getUiComponent()).getText();
			String DataS = ((JTextField)ReservasView.txtDataS.getDateEditor().getUiComponent()).getText();
			Integer valor = Integer.parseInt(txtValor.getText());
			Reserva reservas = new Reserva(java.sql.Date.valueOf(DataE),java.sql.Date.valueOf(DataS),valor,txtFormaPagamento.getSelectedItem().toString());
			this.reserva.salvar(reservas);
		} catch (Exception e) {
